...
| Texts **NO** / "skip"                     | Close **this cycle** as `patient_declined`; reply "No problem." The patient stays enrolled — the next cycle opens on schedule. A decline is not an opt-out.                                                                                                                                                             |
| Texts **STOP** / "unsubscribe"            | Pause the patient + close the thread (carrier-compliant opt-out).                                                                                                                                                                                                                                                       |
| Texts **HELP**                            | Reply with help text.                                                                                                                                                                                                                                                                                                   |
| Texts **START** / "unstop"                | Re-subscribe the patient **and re-open the resupply ladder** (`reopenLadderAfterOptIn`). This second half is load-bearing: `openOutreachEpisode` is the only cycle producer and none of its other callers fire on a START, so without it a STOP-then-START patient would be active, enrolled and never contacted again. |
