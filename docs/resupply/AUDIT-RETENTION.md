...
For PHI flowing through *attachment* storage, see
...
This isn't a HIPAA *requirement* (BAAs don't mandate immutability),
...
basis. If a key name *suggests* PHI (`phone`, `email`, `dob`,
...
A redaction is the surgical zeroing of a *single* row (or a small
...
Open a PR that updates this doc *first*, then changes
