// In-house sign-in page (selected when VITE_AUTH_PROVIDER === "in_house").
//
// Stage 3a contract:
//   * The page is reachable at /sign-in only when the in-house
//     auth path is active. In Clerk mode the legacy SignInPage
//     (Clerk's <SignIn>) is rendered instead.
//   * On success, redirects to the dashboard root. The /me probe
//     in <ConsoleRoute> handles the role check from there.
//   * No "Sign up" link — staff are invited; there is no public
