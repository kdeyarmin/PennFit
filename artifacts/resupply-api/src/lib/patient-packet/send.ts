...
import { renderPacketInviteHtml, renderPacketInviteText } from "./invite-email";

// Patient-facing invite copy lives in a pure module so it can be
// rendered (e.g. by the message-preview gallery) without importing this
// sender. Re-exported because existing callers import them from here.
export { renderPacketInviteHtml, renderPacketInviteText } from "./invite-email";
