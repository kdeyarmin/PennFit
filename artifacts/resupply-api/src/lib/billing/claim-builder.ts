...
export interface ProposedClaimLine {
  ...
  /** Per-unit COGS snapshot (migration 0186), resolved from
...
export async function buildClaimFromFulfillment(
  ...
  // 7b. Stamp the per-unit COGS snapshot (migration 0186) onto the line
 ...
 * carrying the per-unit COGS snapshot (migration 0186) when the builder
