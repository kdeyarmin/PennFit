...
const SYSTEM_PROMPT = [
  ...
  "   - help: patient asks what this is, how it works, wants a human, OR",
  "     raises a question/hesitation about needing the refill, the cost, or",
  '     whether insurance covers it (e.g. "do I really need this?",',
