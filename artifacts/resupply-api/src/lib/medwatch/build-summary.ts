...
export function buildMedWatchSummary(
  ...
  const reportReference =
    grievance.fdaReportReference ?? `CMB-${grievance.id.slice(0, 8)}`;
...
function renderHtml(
  ...
  return [
    ...
    `</table>`,
    `<p style="color:#666;font-size:12px;">Generated by CareMetric Breathe. Do not redistribute. PHI inside.</p>`,
    `</body></html>`,
  ].join("");
}
