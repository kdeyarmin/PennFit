  ...
  async (req, res) => {
    ...
    if (getManualDocumentTypeDef(type).requiresSignature) {
      try {
        ...
        logger.warn(
          { err: redactDbErr(err) },
          "manual_document.tracking_register failed",
        );
      }
    }
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.created audit write failed",
      );
    });
...
router.patch(
  ...
  async (req, res) => {
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.updated audit write failed",
      );
    });
...
router.delete(
  ...
  async (req, res) => {
    ...
    await markTrackingCanceled(
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.tracking_canceled failed",
      ),
    );
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.deleted audit write failed",
      );
    });
...
router.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.pdf render failed",
      );
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.downloaded audit write failed",
      );
    });
...
router.post(
  ...
  async (req, res) => {
    ...
    await recordTrackingSent(
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.tracking_sent failed",
      ),
    );
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.emailed audit write failed",
      );
    });
...
router.post(
  ...
  async (req, res) => {
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.faxed audit write failed",
      );
    });
...
router.post(
  ...
  async (req, res) => {
    ...
    await logAudit({
      ...
      logger.warn(
        { err: redactDbErr(err) },
        "manual_document.attached audit write failed",
      );
    });
