...
const INSURANCE_LEADS: InsuranceLeadRow[] = [
  ...
  },
  {
    ...
    moderatedBy: "demo.csr@pennfit.example",
    createdAt: daysAgo(4),
    updatedAt: daysAgo(2),
  },
  {
...
const RECONCILIATIONS: ReconciliationListItem[] = [
  {
    ...
    status: "draft",
    startedByEmail: "demo.csr@pennfit.example",
    startedAt: daysAgo(1),
    submittedAt: null,
    totalLines: 0,
...
const PACKETS: PacketSummary[] = [
  {
    ...
    last_faxed_at: null,
    created_by_email: "demo.csr@pennfit.example",
  ...
  return [
    {
      ...
      createdBy: "demo.csr@pennfit.example",
      updatedAt: daysAgo(14),
      updatedBy: "demo.csr@pennfit.example",
    },
    {
