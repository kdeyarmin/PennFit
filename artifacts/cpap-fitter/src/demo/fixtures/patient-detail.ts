    ...
    documents: [
      {
        ...
        attached_at: null,
        created_by_email: "demo.admin@pennfit.example",
      ...
      },
      {
        ...
        recipient_email: "casey@pennfit.example",
  ...
  const all = [
    {
      ...
      recipient_email: "jordan@pennfit.example",
      sent_at: daysAgo(20),
...
export function demoPatientOnboarding(_patientId: string) {
  return {
    journey: {
      ...
      day90SentAt: null,
      status: "active",
      enrolledByEmail: "demo.admin@pennfit.example",
    ...
    checks: [
      {
        ...
        requested_by_email: "demo.admin@pennfit.example",
