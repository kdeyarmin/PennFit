  ...
  const needs = [
    {
      ...
      patientEmail: "jordan@pennfit.example",
      episodeId: "demo-ep-1",
    ...
    },
    {
      ...
      patientEmail: "riley@pennfit.example",
      episodeId: null,
      status: "awaiting_admin",
  ...
  const responded = [
    {
      ...
      patientEmail: "casey@pennfit.example",
      episodeId: "demo-ep-2",
    ...
    },
    {
      ...
      patientEmail: "avery@pennfit.example",
      episodeId: null,
      status: "closed",
...
export function demoStaffingLive() {
  const agents = [
    ...
    },
    {
      ...
      email: "morgan.csr@pennfit.example",
    ...
    },
    {
      ...
      email: "riley.csr@pennfit.example",
    ...
    messages: [
      {
        id: `${id}-msg-1`,
        authorRole: "tenant",
        authorEmail: "demo.admin@pennfit.example",
...
function demoFhirPatientResource(id: string) {
  return {
    ...
    telecom: [
      ...
      { system: "email", value: "jordan@pennfit.example" },
    ],
