...
// Rendered at /sign-up only when VITE_AUTH_PROVIDER === "in_house".
// The api-server mounts this auth router with `allowSignUp: true`
// (admin-only resupply-dashboard sets it to false), so this is the
...
export function InHouseSignUpPage() {
