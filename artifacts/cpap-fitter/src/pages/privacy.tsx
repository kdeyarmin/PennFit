        ...
        <CardContent className="space-y-6 text-sm text-foreground/90 leading-relaxed pt-6">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>
                Numerical facial measurements (e.g., nose width in millimeters).
              </li>
              <li>
                Responses to the clinical questionnaire (e.g., preferred sleep
                position).
              </li>
              <li>
              ...
              <li>
                ...
                viewed") tagged with a random per-tab session identifier. These
                contain no name, IP address, device fingerprint, or contact
                information.
              </li>
            </ul>
            <p className="mt-2">
              Measurement and questionnaire data is sent securely to generate a
              mask recommendation and is then discarded — the recommendation
              engine is stateless and does not write your facial measurements to
              any database.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>
                Maintain records required by federal, state, and payer
                regulations.
              </li>
            </ul>
            <p className="mt-2">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>
                Insurance verification follow-ups and prescription requests;
              </li>
              <li>
                Resupply reminders when you are due for new CPAP supplies
                (typically every 30 to 90 days, per your insurance benefit and
                prescribed replacement schedule);
              </li>
              <li>Replies to questions you send us by text.</li>
            </ul>
            <p className="mt-2">
              <strong>Frequency:</strong> Approximately 1 to 2 messages per
              resupply cycle, plus transactional confirmations and any
              follow-ups if you do not respond. You will not receive marketing
            ...
            <p className="mt-2">
              ...
              <em>Message and data rates may apply.</em> Carriers are not liable
