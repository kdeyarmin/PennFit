// In-house sign-in page for the cpap-fitter shop.
//
// Rendered at /sign-in only when VITE_AUTH_PROVIDER === "in_house".
// In Clerk mode the existing pages/sign-in.tsx (Clerk's hosted
// SignIn) renders instead.
//
// On success we redirect to /account (the same fallback Clerk's
// `signInFallbackRedirectUrl` uses) so a returning shopper lands
// on their order history. New customers should use /sign-up
// instead — there's a link below the form.
...
export function InHouseSignInPage() {
