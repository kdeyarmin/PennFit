      ...
      >
        ...
        <table className="w-full text-xs min-w-[720px]">
          ...
          <tbody>
            ...
            {!metricsQuery.isPending &&
              (metricsQuery.data?.touches ?? []).map((m) => {
                  ...
                  <Fragment key={m.touchIndex}>
                    ...
                    >
                      ...
                      <td
                        ...
                        style={{
                          color:
                            m.emailFailures + m.smsFailures > 0
                              ? "#9f1239"
                              : "#9ca3af",
                        }}
                      >
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <label className="text-xs text-slate-600 flex items-center gap-1">
          ...
          <select
            value={source}
            onChange={(e) =>
              setSource(e.target.value as FitterLeadSource | "all")
            }
                  ...
                  >
                    <td className="px-3 py-2 align-top">
                      <div className="font-medium">
                        {r.firstName && (
                          <span className="text-slate-900">{r.firstName} </span>
                        )}
                    ...
                    <td className="px-3 py-2 align-top text-xs">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span
                          ...
                          style={{
                            color:
                              r.engagementScore > 0 ? "#155e75" : "#9ca3af",
                          }}
                        >
                          {r.engagementScore}
                        </span>
                        ...
                        if (clicks > 0 && clicks >= opens) {
                          return (
                            <span style={{ color: "#075985" }}>
                              clicked{" "}
                              {formatRelative(r.lastClickAt as string, nowMs)}
                            </span>
                          );
                        }
                        if (opens > 0) {
                          return (
                            <span style={{ color: "#155e75" }}>
                              opened{" "}
                              {formatRelative(r.lastOpenAt as string, nowMs)}
                            </span>
                          );
                        }
...
function timelineEventStyle(kind: string): CSSProperties {
  if (kind.startsWith("touch_sent"))
    return { background: "#e0e7ff", color: "#3730a3" };
  if (kind === "touch_opened")
