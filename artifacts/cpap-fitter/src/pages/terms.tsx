      ...
      <Card className="border-0 glass-card rounded-2xl">
        ...
        <CardContent className="space-y-6 text-sm text-foreground/90 leading-relaxed pt-6">
          ...
          <section className="space-y-2">
            ...
            <p>
              <LegalName /> uses on-device facial measurements and your
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              are subject to change. <BrandName /> will not knowingly ship
              supplies that are not eligible for coverage under your plan
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>
                <strong>Program name:</strong> <BrandName /> CPAP Resupply
                Notifications.
              </li>
              <li>
              ...
              <li>
                ...
                UNSUBSCRIBE, QUIT, or OPTOUT to any <BrandName /> message at any
                time to stop all <BrandName /> texts. You will receive one final
              ...
              <li>
                <strong>No third-party marketing:</strong> <BrandName /> will
                not sell, rent, or share your mobile phone number or SMS opt-in
            ...
            <p className="mt-2">
              ...
              for how <BrandName /> handles the personal information you
              provide.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              in a manner that could damage, disable, or impair <BrandName />
              's systems; (ii) submit false or misleading patient, insurance, or
              prescription information; (iii) attempt to access another
              patient's records or <BrandName />
              's internal systems without authorization; or (iv) use the Service
              to send unsolicited messages or for any commercial purpose other
              than your own CPAP supply needs.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              <BrandName /> makes no warranties, express or implied, regarding
              the Service, including the accuracy of mask recommendations, the
              timeliness of insurance verification, or the delivery of text
              messages. To the fullest extent permitted by law, <BrandName />{" "}
          ...
          <section className="space-y-2">
            ...
            <p>
              <BrandName /> may update these Terms from time to time. Material
