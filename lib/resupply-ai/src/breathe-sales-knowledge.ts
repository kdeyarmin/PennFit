...
export const BREATHE_PLATFORM_OVERVIEW = [
  ...
  "  patients back on schedule, plus insurance-covered replacement reminders —",
  "  this is what lifts a resupply order rate from the typical ~30% toward the",
  "  45-50% industry benchmark, which is the single biggest revenue lever for a",
  "  DME.",
  "- Billing and revenue tools: insurance eligibility checks, prior-auth, claims",
  "  submission, and denial work queues — so staff stop juggling spreadsheets",
  "  and clearinghouse portals.",
...
export const BREATHE_FEATURE_DETAIL = [
  ...
  "address (its own storefront, logo, and domain); patients see what they're",
  "due for, request masks/cushions/tubing/filters through insurance, and track",
  ...
  "an inbound AI line), and staff place the insurance order — there is no",
  "patient cash-pay checkout. This is the engine behind the order-rate lift.",
  "",
  ...
  "and bill-hold / A/R worklists. The goal is to stop staff from living in",
...
export const BREATHE_VALUE_AND_DIFFERENTIATORS = [
  ...
  "  patients; consistent, automated, multi-channel outreach moves that toward",
  "  the 45-50% benchmark. On an existing patient base that is usually the",
  "  single biggest revenue swing — and it's recurring.",
  ...
  "  reaches out by text, email, and AI phone call, lets patients confirm,",
  "  staff places insurance orders, fits masks remotely, and triages inbound)",
  "  that the repetitive chasing, phone tag, and data entry that used to eat",
  "  hours of staff time every day just happens on its own.",
  ...
  "  built for DME resupply, end to end. It is an insurance-billing platform,",
  "  not a retail store: patients are supplied against their plan and are never",
  "  charged a card, so don't pitch it as e-commerce.",
...
export const BREATHE_FAQ = [
  ...
  "  and patient/resupply data exchanges",
