...
export const BREATHE_PRICING = [
  ...
  "",
  "Standalone product — Virtual Mask Fitter ($149/month, no setup fee):",
  ...
  "Growth $1,899) — and a DME that signs up during the launch has this founder",
  ...
  "- Scale: $3,999/month + $0.65 per active patient per month, plus a $10,000",
