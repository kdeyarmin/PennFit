...
-- admin_users and auth.users. The shared trigger function from 0054 also
-- covers auth.users updatedAt (trigger added below).
...
-- updatedAt trigger for auth.users (missed in migrations 0054-0056
