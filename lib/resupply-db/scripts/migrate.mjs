...
// never collides with Penn Fit's `public.*` tables. The `drizzle`
...
async function main() {
  ...
  try {
    // Block until any concurrent migrator releases the lock. There's
    // no timeout intentionally: we'd rather wait than fail a deploy
    // half-way through migrations.
