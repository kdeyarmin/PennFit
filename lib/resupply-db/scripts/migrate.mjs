 ...
 */
async function baselineLedgerThrough(client, migrations, cutoff) {
...
async function main() {
  ...
  // `--baseline-through=<prefix>`: one-time adoption mode (stamp the
  // already-applied range without executing). See the adoption guard
  // below + docs/runbooks/adopt-migration-ledger.md.
  ...
  try {
    ...
    if (baselineThrough !== null) {
      const stamped = await baselineLedgerThrough(
        client,
        migrations,
        baselineThrough,
      );
