...
async function main() {
  ...
  try {
    ...
    // out. 0025 has long since been applied to every environment, so
    // the assist is gone. If you ever need to replay against a fresh
    // DB rebuilt from a pre-0025 dump, restore this block from git
    // history.)
